...
export function AboutUsPage() {
  return (
    <>
      <section className="w-full py-12 text-foreground md:py-24 lg:py-32">
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                ...
                <Link
                  className="inline-flex h-10 items-center justify-center rounded-md border border-border px-8 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-black/10 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-800  dark:bg-gray-950 dark:hover:bg-gray-800 dark:hover:text-gray-50 dark:focus-visible:ring-gray-300"
                  href="#"
                >
                  Contact Us
                </Link>
      ...
      <section className="w-full bg-gray-100 py-12 text-foreground dark:bg-gray-950 md:py-24 lg:py-32">
        <div className="container px-4 md:px-6">
